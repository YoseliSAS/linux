...
/* 15.3.6.3 Chip Selects Pin Assignment Register (PAR_CS) */
...
#define MCF_GPIO_PAR_CS_CS0_MASK		(0xFE)
...
#define MCF_GPIO_PAR_IRQH_IRQ1_MASK     (0xFC)
#define MCF_GPIO_PAR_IRQH_IRQ1_IRQ1     (0x03)
...
#define MCF_GPIO_PAR_SDHCL_CMD_PWM_B0		(0x08)
...
#define MCF_GPIO_PAR_SDHCL_CLK_PWM_A0		(0x02)
