...
#define MCFINTC2_IPRH		0xfc050000
#define MCFINTC2_IPRL		0xfc050004
#define MCFINTC2_IMRL		0xfc05000c
#define MCFINTC2_IMRH		0xfc050008
...
#define MCFGPIO_PAR_FEC_FEC_MASK		(0xF0)
#define MCFGPIO_PAR_FEC_FEC_GPIO		(0x0D)
#define MCFGPIO_PAR_FEC_FEC_RMII1		(0x0C)
#define MCFGPIO_PAR_FEC_FEC_RMII1FUL		(0x0B)
#define MCFGPIO_PAR_FEC_FEC_RMII_ULPI		(0x0A)
#define MCFGPIO_PAR_FEC_FEC_RMII0		(0x09)
#define MCFGPIO_PAR_FEC_FEC_RMII0FUL_ULPI	(0x08)
#define MCFGPIO_PAR_FEC_FEC_RMII0FUL		(0x07)
#define MCFGPIO_PAR_FEC_FEC_RMII0_1FUL		(0x06)
#define MCFGPIO_PAR_FEC_FEC_RMII0FUL_1		(0x05)	/* 0:Full 1: */
/* Both 0&1: MDC, MDIO, COL & TXER - GPIO */
#define MCFGPIO_PAR_FEC_FEC_RMII0_1		(0x04)
#define MCFGPIO_PAR_FEC_FEC_RMII0FUL_1FUL	(0x03)
#define MCFGPIO_PAR_FEC_FEC_MII		(0x01)	/* MDC & MDIO - GPIO */
#define MCFGPIO_PAR_FEC_FEC_MIIFUL		(0x00)
...
#define MCFEDMA_IRQ_PRIO0	MCFINTC0_ICR0 + MCFINT0_EDMA_INTR0
#define MCFEDMA_IRQ_PRIO16	MCFINTC1_ICR0 + MCFEDMA_EDMA_INTR16
#define MCFEDMA_IRQ_PRIO56	MCFINTC2_ICR0 + MCFEDMA_EDMA_INTR56
